...
import Pill from '@/app/features/auth/components/Pill';
...
describe('Pill', () => {
    ...
    it('applies the correct shadow class', () => {
        ...
        expect(pill.classList.contains('shadow-[0_0_10px_rgba(168,85,247,0.4)]')).toBe(true);
    });
    ...
    it('renders long text correctly', () => {
        const longText = 'este es un texto muuuuuuy largo que deberia renderizarse sin problemass';
    ...
    it('maintains the correct DOM structure', () => {
        const { container } = render(<Pill>Content that I put inside the Pill</Pill>);
