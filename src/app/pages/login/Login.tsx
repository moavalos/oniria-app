...
export default function Login() {
  ...
  return (
    <HudMenu.Root className="relative flex justify-center items-center min-h-screen">
      ...
      <HudMenu.Container className="relative z-10 p-[0px!important] overflow-hidden flex flex-row min-w-sm max-w-4xl w-full bg-gray-700/55 backdrop-blur-2xl">
        <div className="max-w-[50%] w-full p-7">
          <HudMenu.Header baseline={false}>
            <AuthTitle
              title="Oniria"
              subtitle={t("login.subtitle")}
              subtitle2={t("login.subtitle2")}
            />
          </HudMenu.Header>
