...
import NavigationArrows from "@shared/components/NavigationArrows";
import LeftPanel from "@pages/home/components/LeftPanel";
...
function Globe() {
  return (
    <div className="relative aspect-square w-full max-w-[620px] mx-auto">
      ...
      {/* texto centrado */}
      <div className="absolute inset-0 flex items-center justify-center p-10"></div>
      {/* flechas */}
      <NavigationArrows
