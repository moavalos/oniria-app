...
export default function UserProfile({ name, email, onClick }: UserProfileProps) {
    return (
        <div
            onClick={onClick}
            className="hidden md:flex items-center gap-2 rounded-full px-3 py-1.5 border transition-all duration-200 ease-out cursor-pointer"
            style={{
        ...
        >
            <div
                ...
                onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "var(--user-icon-hover-bg)")}
                onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "var(--user-icon-bg)")}
            >
